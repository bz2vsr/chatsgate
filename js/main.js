...
function renderSummary() {
    ...
    document.getElementById('badge-words').innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-alphabet" viewBox="0 0 16 16">
            <path d="M2.204 11.078c.767 0 1.201-.356 1.406-.737h.036l.079.576h1.1V7.125c0-.502-.07-.878-.24-1.123-.234-.32-.683-.51-1.371-.51-.971 0-1.57.366-1.57.366l.264.811s.492-.27 1.125-.27c.449 0 .664.28.664.749v.279l-.307.023c-1.036.071-2.198.427-2.198 1.585 0 .766.474 1.43 1.388 1.43zm.217-.998c-.413 0-.672-.255-.672-.583 0-.458.412-.718 1.01-.771l.293-.023v.515c0 .563-.273.862-.631.862m4.036.998c1.031 0 1.471-.819 1.471-.819h.035l.079.737h1.027V7.125h-1.17v3.618c-.165.17-.506.384-.923.384-.417 0-.641-.26-.641-.778V7.125H5.187v3.754c0 .88.594 1.199 1.27 1.199m3.76-.998c.413 0 .672.255.672.583 0 .459-.412.718-1.01.771l-.293.023v-.515c0-.563.273-.862.631-.862m-.217.998c-1.031 0-1.471.819-1.471.819h-.035l-.079-.737H8.488V13h1.17V9.382c.165-.17.506-.384.923-.384.417 0 .641.26.641.778V13h1.168V9.246c0-.88-.594-1.199-1.27-1.199z"/>
        </svg>
